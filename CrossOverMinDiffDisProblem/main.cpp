...
void test_localSearch(String &filename) {
    ...
    const int tabu_max_length = 2000;
    ...
    sl_two.randomInit();
    mylog << "总节点数：" << sl_one.get_nb_nodes()
        <<"挑选的节点数："<< sl_two.get_sub_nb_nodes() <<= logsw_info;
    CrossOver crossover(matrix, tabuStep, tabu_max_length, population, _param, sl_one, sl_two, sizeTabu, param1, param2, param3);
